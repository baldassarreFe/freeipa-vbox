...
# Change MAC for internal network to get 192.168.56.200 from the DHCP
...
# Provision
scp -F ssh_config -r 04-server/* server:/home/fedora
ssh -F ssh_config server sudo /home/fedora/provision.sh
